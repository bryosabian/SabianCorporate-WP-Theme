...
if (is_front_page()) {
    ...
    $header_classes[] = "nav_transparent light";
...
<meta name="robots" content="index, follow">');
    ...
    <header class="<?php echo implode(" ", $main_header_classes); ?>">
        ...
        <nav class="navbar navbar-default  visible-xs <?php if(is_front_page()){ echo 'navbar-fixed-top nav_transparent'; } ?>" id="sabian_mobile_nav">
